...
class Search {
  ...
  getResults() {
    $.getJSON(townData.root_url + '/wp-json/wp/v2/posts?search=' + this.searchField.val(), posts => {
    $.getJSON(townData.root_url + '/wp-json/wp/v2/pagess?search=' + this.searchField.val(), pages => {
  ...
  <div class="search-overlay__top">
    <div class="container">
      ...
      <input type="text" class="search-term" placeholder="What would you like to find?" id="search-term">
